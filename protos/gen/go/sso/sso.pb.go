...
type IsAdminRequest struct {
	...
	SerId int64 `protobuf:"varint,1,opt,name=ser_id,json=serId,proto3" json:"ser_id,omitempty"` // User ID to validate.
}
...
func (x *IsAdminRequest) GetSerId() int64 {
	if x != nil {
		return x.SerId
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x27, 0x0a, 0x0e, 0x49, 0x73, 0x41, 0x64, 0x6d,
	0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x15, 0x0a, 0x06, 0x73, 0x65, 0x72,
	0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x73, 0x65, 0x72, 0x49, 0x64,
	...
	0x47, 0x6f, 0x41, 0x75, 0x74, 0x68, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73, 0x73,
